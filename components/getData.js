...
export default function GetData() {
    ...
    const calculateResult = (e) => {
        ...
        window.notify('Quiz has been submit', 'success')
    ...
    return (
        ...
        <Navbar/>
            {questions.length > 0 ? (
             ...
             {questions.map((q, i) => (
                ...
                <div className="bg-gray-100 p-8 sm:p-11 rounded-lg shadow-xl">
                    <h2 className="text-xl sm:text-2xl font-semibold mb-2">Q: {q.question}</h2>
            ...
            <div className="text-center">
                <button onClick={calculateResult} type="button" className="my-6 sm:my-10 bg-blue-500 py-2 px-4 sm:px-6 shadow rounded-md text-white">Submit</button>
            </div>
